...
public class TestBusApplication {
	...
	public static void welcomeScreen() {
		...
		System.out.println(" ||        Developer : Ashwini  Deokar ||");
		System.out.println(" ================================================");
		mainMenu();
	}
	...
	public static void userMenu() {
		...
		while (true) {
			...
			case 2:
				...
				Ticket ticket1=ticketObj.showTicketByPNR(pnr_01);
				ticketObj.display(ticket1);
	...
	public static void adminMenu() {
		...
		while (true) {
			...
			case 3:
				...
				System.out.println("Enter Bus Number You want to Book Ticket");
				String busNumber=scanner.next();
				Bus bus=busObj.viewBusDetails(busNumber);
				ticketObj.generateTicket(TicketObjectFactory.getTicketObject(bus));
				break;
			...
			case 7:
				...
				Bus bus1=busObj.viewBusDetails(busNum_01);
				busObj.display(bus1);
				break;
